class OrangeSprintDemo {
    ...
    bindGlobalNav() {
        ...
        logoBtn === null || logoBtn === void 0 ? void 0 : logoBtn.addEventListener('click', () => this.navigate('landing'));
    ...
    `;
        ...
        startBtn === null || startBtn === void 0 ? void 0 : startBtn.addEventListener('click', () => this.navigate('upload'));
        const viewFlow = document.getElementById('view-flow');
        viewFlow === null || viewFlow === void 0 ? void 0 : viewFlow.addEventListener('click', () => this.showToast('点击任务节点可进入学习/练习/模拟考', 'info'));
    }
    renderUpload() {
        var _a, _b, _c;
    ...
    `;
        (_a = document.getElementById('back-home')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.navigate('landing'));
        (_b = document.getElementById('upload-all')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => this.simulateUpload());
        (_c = document.getElementById('next-config')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => this.navigate('questionnaire'));
    }
    simulateUpload() {
        let index = 0;
    ...
    `;
        ...
        const dailyRange = form.querySelector('input[name="daily"]');
        ...
        form.addEventListener('submit', (e) => {
            ...
            this.questionnaire = {
                deadline: data.get('deadline') || this.defaultDeadline(),
                dailyHours: parseFloat(data.get('daily')),
                examDuration: parseInt(data.get('duration'), 10),
        ...
        (_a = document.getElementById('cancel-q')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.navigate('upload'));
    }
    defaultDeadline() {
        const now = new Date();
    ...
    showLoading() {
        ...
        loading === null || loading === void 0 ? void 0 : loading.removeAttribute('hidden');
        setTimeout(() => {
    ...
    `;
        ...
        (_a = document.getElementById('to-complete')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.navigate('complete'));
    }
    bindCountdown() {
        const el = document.getElementById('countdown');
        if (!el || !this.countdownTarget)
            return;
        const update = () => {
            const now = new Date();
    ...
    `;
        (_a = document.getElementById('back-tree')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.navigate('tasks'));
        (_b = document.getElementById('complete-node')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
    ...
    `;
        (_a = document.getElementById('back-tree-2')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.navigate('tasks'));
        (_b = document.getElementById('upload-photo')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => this.showToast('已模拟上传，等待小墨批改…', 'info'));
        (_c = document.getElementById('submit-practice')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => this.gradePractice());
        (_d = document.getElementById('complete-practice')) === null || _d === void 0 ? void 0 : _d.addEventListener('click', () => {
    ...
    `;
        (_a = document.getElementById('back-tree-3')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.navigate('tasks'));
        (_b = document.getElementById('schedule')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => this.showToast('已安排复刷：今晚 20:00', 'success'));
        (_c = document.getElementById('complete-review')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
    ...
    `;
        (_a = document.getElementById('back-tree-4')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.navigate('tasks'));
        (_b = document.getElementById('start-mock')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => this.startMockTimer());
        (_c = document.getElementById('submit-mock')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => this.finishMock());
    }
    startMockTimer() {
    ...
    `;
        result.removeAttribute('hidden');
        (_a = document.getElementById('go-complete')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.navigate('complete'));
    ...
    `;
        (_a = document.getElementById('review-wrong')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => this.navigate('review'));
        (_b = document.getElementById('export-cheatsheet')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => this.showToast('已准备 PDF 小抄（示意）', 'info'));
    }
    markTaskComplete(id) {
